...
export function CoachingTemplateBuilder({clients,templates}:{clients:Client[];templates:Template[]}){
  ...
  useEffect(()=>{setName(current?.name||"My 1:1 Coaching Day");setSections(normalize(current?.sections));setMessage("");},[current,clientId]);
